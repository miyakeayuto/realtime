...
namespace MessagePack.Resolvers
{
    ...
    internal static class GeneratedResolverGetFormatterHelper
    {
        ...
        static GeneratedResolverGetFormatterHelper()
        {
            ...
            {
                { typeof(global::MagicOnionSever.Model.Entity.User), 0 },
                { typeof(global::Shared.Interfaces.Services.Name), 1 },
                { typeof(global::Shared.Interfaces.Services.Number), 2 },
                { typeof(global::Shared.Interfaces.StreamingHubs.JoinedUser), 3 },
            };
        }
        ...
        internal static object GetFormatter(global::System.Type t)
        {
            ...
            switch (key)
            {
                case 0: return new MessagePack.Formatters.MagicOnionSever.Model.Entity.UserFormatter();
                case 1: return new MessagePack.Formatters.Shared.Interfaces.Services.NameFormatter();
                case 2: return new MessagePack.Formatters.Shared.Interfaces.Services.NumberFormatter();
                case 3: return new MessagePack.Formatters.Shared.Interfaces.StreamingHubs.JoinedUserFormatter();
                default: return null;
            }
        }
    }
...
namespace MessagePack.Formatters.MagicOnionSever.Model.Entity
{
    public sealed class UserFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::MagicOnionSever.Model.Entity.User>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::MagicOnionSever.Model.Entity.User value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
        ...
        public global::MagicOnionSever.Model.Entity.User Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::MagicOnionSever.Model.Entity.User();
...
{
    public sealed class NameFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Interfaces.Services.Name>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Interfaces.Services.Name value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
        ...
        public global::Shared.Interfaces.Services.Name Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            global::MessagePack.IFormatterResolver formatterResolver = options.Resolver;
            var length = reader.ReadArrayHeader();
            var ____result = new global::Shared.Interfaces.Services.Name();
...
namespace MessagePack.Formatters.Shared.Interfaces.StreamingHubs
{
    public sealed class JoinedUserFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Interfaces.StreamingHubs.JoinedUser>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Interfaces.StreamingHubs.JoinedUser value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::MagicOnionSever.Model.Entity.User>(formatterResolver).Serialize(ref writer, value.UserData, options);
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        ____result.UserData = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::MagicOnionSever.Model.Entity.User>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    case 2:
